...
module dilation_accel_AxiStream2MatStream (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] p_Result_2_fu_539_p2;
...
wire   [31:0] p_Result_4_fu_626_p2;
...
wire   [7:0] tmp_8_fu_649_p1;
wire   [7:0] lshr_ln414_fu_656_p2;
wire   [7:0] p_Result_1_fu_662_p2;
reg   [7:0] tmp_6_fu_675_p4;
...
dilation_accel_mul_32s_32s_32_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
        if (((icmp_ln1084_reg_820_pp0_iter2_reg == 1'd0) & (icmp_ln1073_reg_799_pp0_iter2_reg == 1'd1))) begin
            ...
            ap_phi_reg_pp0_iter4_localbuffer_V_8_reg_155 <= p_Result_3_fu_706_p2;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln1104_reg_811_pp0_iter3_reg == 1'd1) & (ap_enable_reg_pp0_iter4 == 1'b1) & (in_mat_419_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_empty_n == 1'b0) & (ap_predicate_op102_read_state6 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln1104_reg_811_pp0_iter3_reg == 1'd1) & (ap_enable_reg_pp0_iter4 == 1'b1) & (in_mat_419_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_empty_n == 1'b0) & (ap_predicate_op102_read_state6 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln1104_reg_811_pp0_iter3_reg == 1'd1) & (ap_enable_reg_pp0_iter4 == 1'b1) & (in_mat_419_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_empty_n == 1'b0) & (ap_predicate_op102_read_state6 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state8_pp0_stage0_iter4 = ((icmp_ln1104_reg_811_pp0_iter3_reg == 1'd1) & (in_mat_419_full_n == 1'b0));
end
...
assign in_mat_419_din = (select_ln1078_fu_726_p3 & ap_phi_reg_pp0_iter4_localbuffer_V_8_reg_155);

assign j_2_fu_239_p3 = ((bLast_fu_223_p2[0:0] == 1'b1) ? 32'd0 : add_ln1105_fu_233_p2);

assign last_blk_width_cast1_i_fu_188_p1 = last_blk_width_read_reg_767;

assign localbuffer_V_6_fu_631_p1 = p_Result_4_fu_626_p2[7:0];

assign localbuffer_V_fu_668_p3 = ((icmp_ln1085_reg_841_pp0_iter2_reg[0:0] == 1'b1) ? 8'd0 : p_Result_1_fu_662_p2);
...
assign p_Result_1_fu_662_p2 = (tmp_8_fu_649_p1 & lshr_ln414_fu_656_p2);

assign p_Result_2_fu_539_p2 = (lshr_ln674_2_fu_533_p2 & ldata1_dout);

assign p_Result_3_fu_706_p2 = (and_ln414_2_fu_701_p2 | and_ln414_1_fu_695_p2);

assign p_Result_4_fu_626_p2 = (lshr_ln674_4_fu_620_p2 & lshr_ln674_3_reg_892);
...
assign select_ln414_3_fu_684_p3 = ((icmp_ln414_reg_870_pp0_iter2_reg[0:0] == 1'b1) ? tmp_6_fu_675_p4 : shl_ln414_reg_912);

assign select_ln414_fu_554_p3 = ((icmp_ln414_reg_870[0:0] == 1'b1) ? trunc_ln414_reg_878 : trunc_ln414_1_reg_886);

assign select_ln674_1_fu_496_p3 = ((icmp_ln674_reg_851[0:0] == 1'b1) ? tmp_2_fu_474_p4 : p_Val2_s_fu_98);
...
assign select_ln674_4_fu_451_p3 = ((icmp_ln674_1_reg_824[0:0] == 1'b1) ? tmp_7_fu_436_p4 : p_Val2_s_fu_98);
...
assign shl_ln414_fu_588_p2 = tmp_10_fu_545_p1 << zext_ln414_1_fu_576_p1;
...
assign tmp_10_fu_545_p1 = p_Result_2_fu_539_p2[7:0];
...
always @ (p_Val2_s_fu_98) begin
    for (ap_tvar_int_0 = 32 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 31 - 0) begin
            tmp_2_fu_474_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_2_fu_474_p4[ap_tvar_int_0] = p_Val2_s_fu_98[31 - ap_tvar_int_0];
        end
    end
end
...
always @ (shl_ln414_reg_912) begin
    for (ap_tvar_int_1 = 8 - 1; ap_tvar_int_1 >= 0; ap_tvar_int_1 = ap_tvar_int_1 - 1) begin
        if (ap_tvar_int_1 > 7 - 0) begin
            tmp_6_fu_675_p4[ap_tvar_int_1] = 1'b0;
        end else begin
            tmp_6_fu_675_p4[ap_tvar_int_1] = shl_ln414_reg_912[7 - ap_tvar_int_1];
        end
    end
end
...
always @ (p_Val2_s_fu_98) begin
    for (ap_tvar_int_2 = 32 - 1; ap_tvar_int_2 >= 0; ap_tvar_int_2 = ap_tvar_int_2 - 1) begin
        if (ap_tvar_int_2 > 31 - 0) begin
            tmp_7_fu_436_p4[ap_tvar_int_2] = 1'b0;
        end else begin
            tmp_7_fu_436_p4[ap_tvar_int_2] = p_Val2_s_fu_98[31 - ap_tvar_int_2];
        end
    end
end

assign tmp_8_fu_649_p1 = p_Result_s_fu_644_p2[7:0];
...
endmodule //dilation_accel_AxiStream2MatStream
