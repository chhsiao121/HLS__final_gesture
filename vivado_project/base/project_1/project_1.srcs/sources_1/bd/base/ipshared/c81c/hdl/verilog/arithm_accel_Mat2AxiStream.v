...
module arithm_accel_Mat2AxiStream (
        imgOutput_436_dout,
...
wire    MatStream2AxiStream_U0_imgOutput_436_read;
wire   [7:0] MatStream2AxiStream_U0_ldata1_din;
...
arithm_accel_last_blk_pxl_width14 last_blk_pxl_width14_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
arithm_accel_MatStream2AxiStream MatStream2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .imgOutput_436_read(MatStream2AxiStream_U0_imgOutput_436_read),
...
arithm_accel_fifo_w4_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w32_d2_S_x rows_c_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w32_d2_S_x cols_c_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign imgOutput_436_read = MatStream2AxiStream_U0_imgOutput_436_read;
...
endmodule //arithm_accel_Mat2AxiStream
