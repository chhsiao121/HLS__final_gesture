...
module dilation_accel_MatStream2AxiStream (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
dilation_accel_mul_32ns_32ns_64_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
mul_32ns_32ns_64_2_1_U114(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_173_p0),
    .din1(grp_fu_173_p1),
...
always @ (posedge ap_clk) begin
    if ((~((cols_bound_per_npc_empty_n == 1'b0) | (rows_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        localbuffer_V_fu_80 <= ret_10_fu_342_p2;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0) & (ap_predicate_op69_write_state6 == 1'b1)) | ((icmp_ln1324_reg_414 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (out_mat_420_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0) & (ap_predicate_op69_write_state6 == 1'b1)) | ((icmp_ln1324_reg_414 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (out_mat_420_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0) & (ap_predicate_op69_write_state6 == 1'b1)) | ((icmp_ln1324_reg_414 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (out_mat_420_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((icmp_ln1324_reg_414 == 1'd0) & (out_mat_420_empty_n == 1'b0));
end
...
assign ret_10_fu_342_p2 = (r_3_fu_337_p2 | localbuffer_V_fu_80);
...
assign zext_ln208_fu_246_p1 = out_mat_420_dout;
...
endmodule //dilation_accel_MatStream2AxiStream
