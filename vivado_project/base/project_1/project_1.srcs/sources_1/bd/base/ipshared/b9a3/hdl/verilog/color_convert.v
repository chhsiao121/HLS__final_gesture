...
(* CORE_GENERATION_INFO="color_convert,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=6.380000,HLS_SYN_LAT=6,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=6,HLS_SYN_FF=1099,HLS_SYN_LUT=1009,HLS_VERSION=2019_2}" *)
...
wire    regslice_both_stream_out_24_data_U_apdone_blk;
...
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire    regslice_both_stream_in_24_data_U_apdone_blk;
wire   [23:0] stream_in_24_TDATA_int;
wire    stream_in_24_TVALID_int;
reg    stream_in_24_TREADY_int;
wire    regslice_both_stream_in_24_data_U_ack_in;
...
wire   [23:0] stream_out_24_TDATA_int;
reg    stream_out_24_TVALID_int;
wire    stream_out_24_TREADY_int;
wire    regslice_both_stream_out_24_data_U_vld_out;
...
regslice_both #(
    .DataWidth( 24 ))
regslice_both_stream_out_24_data_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .vld_out(regslice_both_stream_out_24_data_U_vld_out),
    .ack_out(stream_out_24_TREADY),
    .apdone_blk(regslice_both_stream_out_24_data_U_apdone_blk)
);
...
regslice_both_stream_out_24_user_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(stream_in_24_user_V_s_reg_910_pp0_iter4_reg),
    .vld_in(stream_out_24_TVALID_int),
...
regslice_both_stream_out_24_last_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(stream_in_24_last_V_s_reg_915_pp0_iter4_reg),
    .vld_in(stream_out_24_TVALID_int),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_Repl2_1_reg_925 <= {{stream_in_24_TDATA_int[15:8]}};
        p_Repl2_2_reg_930 <= {{stream_in_24_TDATA_int[23:16]}};
        ...
        stream_in_24_last_V_s_reg_915 <= stream_in_24_TLAST_int;
        stream_in_24_last_V_s_reg_915_pp0_iter1_reg <= stream_in_24_last_V_s_reg_915;
        stream_in_24_user_V_s_reg_910 <= stream_in_24_TUSER_int;
...
always @ (*) begin
    if (((stream_in_24_TVALID == 1'b1) & (regslice_both_stream_in_24_data_U_ack_in == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((regslice_both_stream_out_24_data_U_apdone_blk == 1'b1) & (ap_enable_reg_pp0_iter6 == 1'b1)) | ((stream_in_24_TVALID_int == 1'b0) & (1'b1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter6 == 1'b1) & ((stream_out_24_TREADY_int == 1'b0) | (regslice_both_stream_out_24_data_U_apdone_blk == 1'b1))) | ((stream_out_24_TREADY_int == 1'b0) & (ap_enable_reg_pp0_iter5 == 1'b1)) | ((stream_in_24_TVALID_int == 1'b0) & (1'b1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter6 == 1'b1) & ((stream_out_24_TREADY_int == 1'b0) | (regslice_both_stream_out_24_data_U_apdone_blk == 1'b1))) | ((stream_out_24_TREADY_int == 1'b0) & (ap_enable_reg_pp0_iter5 == 1'b1)) | ((stream_in_24_TVALID_int == 1'b0) & (1'b1 == 1'b1)));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = (stream_in_24_TVALID_int == 1'b0);
end
...
always @ (*) begin
    ap_block_state7_pp0_stage0_iter6 = (regslice_both_stream_out_24_data_U_apdone_blk == 1'b1);
end
...
assign p_Repl2_s_fu_215_p1 = stream_in_24_TDATA_int[7:0];
...
assign stream_out_24_TDATA_int = {{{out3_V_fu_846_p3}, {out2_V_fu_788_p3}}, {out1_V_fu_730_p3}};

assign stream_out_24_TVALID = regslice_both_stream_out_24_data_U_vld_out;
