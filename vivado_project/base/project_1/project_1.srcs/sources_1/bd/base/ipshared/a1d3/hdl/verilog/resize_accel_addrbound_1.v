...
module resize_accel_addrbound_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    cols_out_blk_n;
reg    ap_block_state1;
reg   [12:0] return_r_preg;
wire    ap_CS_fsm_state4;
wire  signed [14:0] grp_fu_109_p2;
wire   [17:0] shl_ln_fu_85_p3;
wire   [17:0] add_ln997_fu_92_p2;
wire  signed [14:0] grp_fu_109_p0;
wire  signed [14:0] grp_fu_109_p1;
reg    grp_fu_109_ce;
reg   [3:0] ap_NS_fsm;
wire    ap_ce_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
#0 return_r_preg = 13'd0;
end

resize_accel_mul_mul_15s_15s_15_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 15 ),
    .din1_WIDTH( 15 ),
    .dout_WIDTH( 15 ))
mul_mul_15s_15s_15_4_1_U26(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_109_p0),
    .din1(grp_fu_109_p1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state4)) begin
            return_r_preg <= {{add_ln997_fu_92_p2[17:5]}};
        end
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        return_r = {{add_ln997_fu_92_p2[17:5]}};
    end else begin
...
assign add_ln997_fu_92_p2 = (shl_ln_fu_85_p3 + 18'd31);
...
assign grp_fu_109_p0 = rows_dout[14:0];

assign grp_fu_109_p1 = cols_dout[14:0];

assign rows_out_din = rows_dout;

assign shl_ln_fu_85_p3 = {{grp_fu_109_p2}, {3'd0}};

endmodule //resize_accel_addrbound_1
