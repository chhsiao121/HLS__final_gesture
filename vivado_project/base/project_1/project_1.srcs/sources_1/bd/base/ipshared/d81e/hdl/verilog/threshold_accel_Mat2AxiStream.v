...
module threshold_accel_Mat2AxiStream (
        out_mat_420_dout,
        out_mat_420_empty_n,
        out_mat_420_read,
        ldata1_din,
...
threshold_accel_last_blk_pxl_width13 last_blk_pxl_width13_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_MatStream2AxiStream MatStream2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_fifo_w4_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S_x rows_c_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S_x cols_c_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //threshold_accel_Mat2AxiStream
