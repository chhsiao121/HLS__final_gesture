...
wire    Mat2AxiStream_U0_out_mat_419_read;
...
resize_accel_Mat2Axi_entry17 Mat2Axi_entry17_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
resize_accel_addrbound addrbound_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
resize_accel_Mat2Axi_Block_split35_proc Mat2Axi_Block_split35_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
resize_accel_Mat2AxiStream Mat2AxiStream_U0(
    .out_mat_419_dout(out_mat_419_dout),
    .out_mat_419_empty_n(out_mat_419_empty_n),
    .out_mat_419_read(Mat2AxiStream_U0_out_mat_419_read),
...
resize_accel_AxiStream2Axi AxiStream2Axi_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
resize_accel_fifo_w64_d4_S_x dout_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w11_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w32_d2_S_x0 rows_c12_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w11_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w32_d2_S_x0 cols_c13_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w9_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w9_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w32_d2_S_x0 ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_start_for_addrbound_U0 start_for_addrbound_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_start_for_Mat2AxiStream_U0 start_for_Mat2AxiStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = ((axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound_U0_ap_idle & Mat2Axi_entry17_U0_ap_idle & Mat2Axi_Block_split35_proc_U0_ap_idle & Mat2AxiStream_U0_ap_idle & AxiStream2Axi_U0_ap_idle);
...
assign out_mat_419_read = Mat2AxiStream_U0_out_mat_419_read;

assign start_for_Mat2AxiStream_U0_din = 1'b1;

assign start_for_addrbound_U0_din = 1'b1;

endmodule //resize_accel_Mat2Axi
