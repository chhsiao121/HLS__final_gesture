...
module threshold_accel_Mat2Axi (
        out_mat_420_dout,
        out_mat_420_empty_n,
        out_mat_420_read,
        m_axi_gmem2_AWVALID,
...
wire    Mat2Axi_entry16_U0_start_full_n;
...
threshold_accel_Mat2Axi_entry16 Mat2Axi_entry16_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(Mat2Axi_entry16_U0_ap_start),
    .start_full_n(Mat2Axi_entry16_U0_start_full_n),
...
threshold_accel_addrbound addrbound_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_Mat2Axi_Block_split35_proc Mat2Axi_Block_split35_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_Mat2AxiStream Mat2AxiStream_U0(
...
threshold_accel_AxiStream2Axi AxiStream2Axi_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_fifo_w64_d4_S_x dout_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w11_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S_x0 rows_c12_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w11_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S_x0 cols_c13_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w9_d2_S_x p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w9_d2_S_x axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S_x0 ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_start_for_addrbound_U0 start_for_addrbound_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_start_for_Mat2AxiStream_U0 start_for_Mat2AxiStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Mat2Axi_entry16_U0_ap_start = ap_start;

assign Mat2Axi_entry16_U0_start_full_n = (start_for_addrbound_U0_full_n & start_for_Mat2AxiStream_U0_full_n);
...
assign ap_idle = ((axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound_U0_ap_idle & Mat2Axi_entry16_U0_ap_idle & Mat2Axi_Block_split35_proc_U0_ap_idle & Mat2AxiStream_U0_ap_idle & AxiStream2Axi_U0_ap_idle);

assign ap_ready = Mat2Axi_entry16_U0_ap_ready;

assign ap_sync_continue = ap_continue;

assign ap_sync_done = AxiStream2Axi_U0_ap_done;

assign ap_sync_ready = Mat2Axi_entry16_U0_ap_ready;
...
endmodule //threshold_accel_Mat2Axi
