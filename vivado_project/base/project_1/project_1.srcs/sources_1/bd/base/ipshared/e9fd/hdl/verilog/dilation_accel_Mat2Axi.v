...
wire    Mat2Axi_entry33_U0_ap_start;
wire    Mat2Axi_entry33_U0_start_full_n;
wire    Mat2Axi_entry33_U0_ap_done;
wire    Mat2Axi_entry33_U0_ap_continue;
wire    Mat2Axi_entry33_U0_ap_idle;
wire    Mat2Axi_entry33_U0_ap_ready;
wire    Mat2Axi_entry33_U0_start_out;
wire    Mat2Axi_entry33_U0_start_write;
wire   [63:0] Mat2Axi_entry33_U0_dout_out_din;
wire    Mat2Axi_entry33_U0_dout_out_write;
wire   [10:0] Mat2Axi_entry33_U0_rows_out_din;
wire    Mat2Axi_entry33_U0_rows_out_write;
wire   [31:0] Mat2Axi_entry33_U0_rows_out1_din;
wire    Mat2Axi_entry33_U0_rows_out1_write;
wire   [10:0] Mat2Axi_entry33_U0_cols_out_din;
wire    Mat2Axi_entry33_U0_cols_out_write;
wire   [31:0] Mat2Axi_entry33_U0_cols_out2_din;
wire    Mat2Axi_entry33_U0_cols_out2_write;
...
wire   [8:0] addrbound_U0_return_r;
...
wire   [8:0] Mat2Axi_Block_split35_proc_U0_ap_return;
wire    ap_channel_done_axibound_V;
wire    axibound_V_full_n;
wire    Mat2AxiStream_U0_out_mat_420_read;
...
dilation_accel_Mat2Axi_entry33 Mat2Axi_entry33_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(Mat2Axi_entry33_U0_ap_start),
    .start_full_n(Mat2Axi_entry33_U0_start_full_n),
    .ap_done(Mat2Axi_entry33_U0_ap_done),
    .ap_continue(Mat2Axi_entry33_U0_ap_continue),
    .ap_idle(Mat2Axi_entry33_U0_ap_idle),
    .ap_ready(Mat2Axi_entry33_U0_ap_ready),
    .start_out(Mat2Axi_entry33_U0_start_out),
    .start_write(Mat2Axi_entry33_U0_start_write),
    .dout(dout),
    .rows(rows),
    .cols(cols),
    .dout_out_din(Mat2Axi_entry33_U0_dout_out_din),
    .dout_out_full_n(dout_c_full_n),
    .dout_out_write(Mat2Axi_entry33_U0_dout_out_write),
    .rows_out_din(Mat2Axi_entry33_U0_rows_out_din),
    .rows_out_full_n(rows_c_full_n),
    .rows_out_write(Mat2Axi_entry33_U0_rows_out_write),
    .rows_out1_din(Mat2Axi_entry33_U0_rows_out1_din),
    .rows_out1_full_n(rows_c12_full_n),
    .rows_out1_write(Mat2Axi_entry33_U0_rows_out1_write),
    .cols_out_din(Mat2Axi_entry33_U0_cols_out_din),
    .cols_out_full_n(cols_c_full_n),
    .cols_out_write(Mat2Axi_entry33_U0_cols_out_write),
    .cols_out2_din(Mat2Axi_entry33_U0_cols_out2_din),
    .cols_out2_full_n(cols_c13_full_n),
    .cols_out2_write(Mat2Axi_entry33_U0_cols_out2_write)
);

dilation_accel_addrbound addrbound_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
dilation_accel_Mat2Axi_Block_split35_proc Mat2Axi_Block_split35_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
dilation_accel_Mat2AxiStream Mat2AxiStream_U0(
    .out_mat_420_dout(out_mat_420_dout),
    .out_mat_420_empty_n(out_mat_420_empty_n),
    .out_mat_420_read(Mat2AxiStream_U0_out_mat_420_read),
...
dilation_accel_AxiStream2Axi AxiStream2Axi_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
dilation_accel_fifo_w64_d4_S_x dout_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Mat2Axi_entry33_U0_dout_out_din),
    .if_full_n(dout_c_full_n),
    .if_write(Mat2Axi_entry33_U0_dout_out_write),
    .if_dout(dout_c_dout),
    .if_empty_n(dout_c_empty_n),
    .if_read(AxiStream2Axi_U0_dout_read)
);

dilation_accel_fifo_w11_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Mat2Axi_entry33_U0_rows_out_din),
    .if_full_n(rows_c_full_n),
    .if_write(Mat2Axi_entry33_U0_rows_out_write),
    .if_dout(rows_c_dout),
    .if_empty_n(rows_c_empty_n),
    .if_read(addrbound_U0_rows_read)
);

dilation_accel_fifo_w32_d2_S_x0 rows_c12_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Mat2Axi_entry33_U0_rows_out1_din),
    .if_full_n(rows_c12_full_n),
    .if_write(Mat2Axi_entry33_U0_rows_out1_write),
    .if_dout(rows_c12_dout),
    .if_empty_n(rows_c12_empty_n),
    .if_read(Mat2AxiStream_U0_rows_read)
);

dilation_accel_fifo_w11_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Mat2Axi_entry33_U0_cols_out_din),
    .if_full_n(cols_c_full_n),
    .if_write(Mat2Axi_entry33_U0_cols_out_write),
    .if_dout(cols_c_dout),
    .if_empty_n(cols_c_empty_n),
    .if_read(addrbound_U0_cols_read)
);

dilation_accel_fifo_w32_d2_S_x0 cols_c13_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Mat2Axi_entry33_U0_cols_out2_din),
    .if_full_n(cols_c13_full_n),
    .if_write(Mat2Axi_entry33_U0_cols_out2_write),
    .if_dout(cols_c13_dout),
    .if_empty_n(cols_c13_empty_n),
    .if_read(Mat2AxiStream_U0_cols_read)
);

dilation_accel_fifo_w9_d2_S_x p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
dilation_accel_fifo_w9_d2_S_x axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
dilation_accel_fifo_w32_d2_S_x0 ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
dilation_accel_start_for_addrbound_U0 start_for_addrbound_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_write(Mat2Axi_entry33_U0_start_write),
    .if_dout(start_for_addrbound_U0_dout),
    .if_empty_n(start_for_addrbound_U0_empty_n),
    .if_read(addrbound_U0_ap_ready)
);

dilation_accel_start_for_Mat2AxiStream_U0 start_for_Mat2AxiStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Mat2Axi_entry33_U0_ap_continue = 1'b1;

assign Mat2Axi_entry33_U0_ap_start = ap_start;

assign Mat2Axi_entry33_U0_start_full_n = (start_for_addrbound_U0_full_n & start_for_Mat2AxiStream_U0_full_n);
...
assign ap_idle = ((axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound_U0_ap_idle & Mat2Axi_entry33_U0_ap_idle & Mat2Axi_Block_split35_proc_U0_ap_idle & Mat2AxiStream_U0_ap_idle & AxiStream2Axi_U0_ap_idle);

assign ap_ready = Mat2Axi_entry33_U0_ap_ready;

assign ap_sync_continue = ap_continue;

assign ap_sync_done = AxiStream2Axi_U0_ap_done;

assign ap_sync_ready = Mat2Axi_entry33_U0_ap_ready;
...
assign out_mat_420_read = Mat2AxiStream_U0_out_mat_420_read;

assign start_for_Mat2AxiStream_U0_din = 1'b1;

assign start_for_addrbound_U0_din = 1'b1;

endmodule //dilation_accel_Mat2Axi
