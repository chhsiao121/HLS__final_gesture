...
module dilation_accel_addrbound (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
dilation_accel_mul_mul_11s_11s_11_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 11 ),
    .din1_WIDTH( 11 ),
    .dout_WIDTH( 11 ))
mul_mul_11s_11s_11_4_1_U104(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(rows_dout),
    .din1(cols_dout),
...
assign shl_ln_fu_55_p3 = {{grp_fu_79_p2}, {3'd0}};

endmodule //dilation_accel_addrbound
