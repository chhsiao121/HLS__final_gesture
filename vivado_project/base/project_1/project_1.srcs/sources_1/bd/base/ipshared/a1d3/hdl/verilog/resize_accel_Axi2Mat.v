...
wire    Axi2Mat_entry8_U0_ap_done;
wire    Axi2Mat_entry8_U0_ap_continue;
wire    Axi2Mat_entry8_U0_ap_idle;
wire    Axi2Mat_entry8_U0_ap_ready;
wire    Axi2Mat_entry8_U0_start_out;
wire    Axi2Mat_entry8_U0_start_write;
wire    Axi2Mat_entry8_U0_din_read;
wire    Axi2Mat_entry8_U0_rows_read;
wire    Axi2Mat_entry8_U0_cols_read;
wire   [63:0] Axi2Mat_entry8_U0_din_out_din;
wire    Axi2Mat_entry8_U0_din_out_write;
wire   [31:0] Axi2Mat_entry8_U0_rows_out_din;
wire    Axi2Mat_entry8_U0_rows_out_write;
wire   [31:0] Axi2Mat_entry8_U0_cols_out_din;
wire    Axi2Mat_entry8_U0_cols_out_write;
...
wire   [12:0] addrbound_1_U0_return_r;
...
wire   [12:0] Axi2Mat_Block_split37_proc_U0_ap_return;
...
wire   [7:0] AxiStream2MatStream_U0_in_mat_418_din;
wire    AxiStream2MatStream_U0_in_mat_418_write;
...
wire   [0:0] start_for_Axi2Mat_entry8_U0_din;
wire    start_for_Axi2Mat_entry8_U0_full_n;
wire   [0:0] start_for_Axi2Mat_entry8_U0_dout;
wire    start_for_Axi2Mat_entry8_U0_empty_n;
...
resize_accel_Axi2Mat_entry3 Axi2Mat_entry3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(Axi2Mat_entry3_U0_ap_start),
    .start_full_n(start_for_Axi2Mat_entry8_U0_full_n),
...
resize_accel_Axi2Mat_entry8 Axi2Mat_entry8_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(Axi2Mat_entry8_U0_ap_start),
    .start_full_n(start_for_addrbound_1_U0_full_n),
    .ap_done(Axi2Mat_entry8_U0_ap_done),
    .ap_continue(Axi2Mat_entry8_U0_ap_continue),
    .ap_idle(Axi2Mat_entry8_U0_ap_idle),
    .ap_ready(Axi2Mat_entry8_U0_ap_ready),
    .start_out(Axi2Mat_entry8_U0_start_out),
    .start_write(Axi2Mat_entry8_U0_start_write),
    .din_dout(din_c1_dout),
    .din_empty_n(din_c1_empty_n),
    .din_read(Axi2Mat_entry8_U0_din_read),
    .rows_dout(rows_c2_dout),
    .rows_empty_n(rows_c2_empty_n),
    .rows_read(Axi2Mat_entry8_U0_rows_read),
    .cols_dout(cols_c3_dout),
    .cols_empty_n(cols_c3_empty_n),
    .cols_read(Axi2Mat_entry8_U0_cols_read),
    .din_out_din(Axi2Mat_entry8_U0_din_out_din),
    .din_out_full_n(din_c_full_n),
    .din_out_write(Axi2Mat_entry8_U0_din_out_write),
    .rows_out_din(Axi2Mat_entry8_U0_rows_out_din),
    .rows_out_full_n(rows_c_full_n),
    .rows_out_write(Axi2Mat_entry8_U0_rows_out_write),
    .cols_out_din(Axi2Mat_entry8_U0_cols_out_din),
    .cols_out_full_n(cols_c_full_n),
    .cols_out_write(Axi2Mat_entry8_U0_cols_out_write)
);
...
resize_accel_addrbound_1 addrbound_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
resize_accel_Axi2Mat_Block_split37_proc Axi2Mat_Block_split37_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
resize_accel_Axi2AxiStream Axi2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
resize_accel_AxiStream2MatStream AxiStream2MatStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .in_mat_418_din(AxiStream2MatStream_U0_in_mat_418_din),
    .in_mat_418_full_n(in_mat_418_full_n),
    .in_mat_418_write(AxiStream2MatStream_U0_in_mat_418_write),
...
resize_accel_fifo_w64_d2_S din_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_read(Axi2Mat_entry8_U0_din_read)
);

resize_accel_fifo_w32_d2_S rows_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_read(Axi2Mat_entry8_U0_rows_read)
);

resize_accel_fifo_w32_d2_S cols_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_read(Axi2Mat_entry8_U0_cols_read)
);

resize_accel_fifo_w64_d4_S din_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Axi2Mat_entry8_U0_din_out_din),
    .if_full_n(din_c_full_n),
    .if_write(Axi2Mat_entry8_U0_din_out_write),
    .if_dout(din_c_dout),
    .if_empty_n(din_c_empty_n),
    .if_read(Axi2AxiStream_U0_din_read)
);

resize_accel_fifo_w32_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Axi2Mat_entry8_U0_rows_out_din),
    .if_full_n(rows_c_full_n),
    .if_write(Axi2Mat_entry8_U0_rows_out_write),
    .if_dout(rows_c_dout),
    .if_empty_n(rows_c_empty_n),
    .if_read(addrbound_1_U0_rows_read)
);

resize_accel_fifo_w32_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Axi2Mat_entry8_U0_cols_out_din),
    .if_full_n(cols_c_full_n),
    .if_write(Axi2Mat_entry8_U0_cols_out_write),
    .if_dout(cols_c_dout),
    .if_empty_n(cols_c_empty_n),
    .if_read(addrbound_1_U0_cols_read)
);

resize_accel_fifo_w4_d6_S last_blk_width_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w13_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w32_d4_S rows_c15_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w32_d4_S cols_c16_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w13_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w32_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_start_for_Axi2Mat_entry8_U0 start_for_Axi2Mat_entry8_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_Axi2Mat_entry8_U0_din),
    .if_full_n(start_for_Axi2Mat_entry8_U0_full_n),
    .if_write(Axi2Mat_entry3_U0_start_write),
    .if_dout(start_for_Axi2Mat_entry8_U0_dout),
    .if_empty_n(start_for_Axi2Mat_entry8_U0_empty_n),
    .if_read(Axi2Mat_entry8_U0_ap_ready)
);

resize_accel_start_for_addrbound_1_U0 start_for_addrbound_1_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_write(Axi2Mat_entry8_U0_start_write),
    .if_dout(start_for_addrbound_1_U0_dout),
    .if_empty_n(start_for_addrbound_1_U0_empty_n),
    .if_read(addrbound_1_U0_ap_ready)
);

resize_accel_start_for_AxiStream2MatStream_U0 start_for_AxiStream2MatStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Axi2Mat_entry8_U0_ap_continue = 1'b1;

assign Axi2Mat_entry8_U0_ap_start = start_for_Axi2Mat_entry8_U0_empty_n;
...
assign ap_idle = (last_blk_pxl_width_U0_ap_idle & (axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound_1_U0_ap_idle & AxiStream2MatStream_U0_ap_idle & Axi2Mat_entry8_U0_ap_idle & Axi2Mat_entry3_U0_ap_idle & Axi2Mat_Block_split37_proc_U0_ap_idle & Axi2AxiStream_U0_ap_idle);
...
assign in_mat_418_din = AxiStream2MatStream_U0_in_mat_418_din;

assign in_mat_418_write = AxiStream2MatStream_U0_in_mat_418_write;
