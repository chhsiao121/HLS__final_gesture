...
module median_blur_accel_addrbound (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [10:0] trunc_ln997_fu_61_p1;
wire  signed [15:0] grp_fu_91_p4;
wire   [15:0] grp_fu_91_p0;
wire   [15:0] grp_fu_91_p1;
wire   [5:0] grp_fu_91_p3;
...
median_blur_accel_ama_submuladd_16ns_16ns_16s_6ns_16_4_1 #(
    ...
    .din3_WIDTH( 6 ),
    .dout_WIDTH( 16 ))
ama_submuladd_16ns_16ns_16s_6ns_16_4_1_U106(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_91_p0),
    .din1(grp_fu_91_p1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state4)) begin
            return_r_preg <= {{grp_fu_91_p4[15:5]}};
        end
    end
end
...
assign grp_fu_91_p0 = {{trunc_ln997_fu_61_p1}, {5'd0}};

assign grp_fu_91_p1 = {{rows_dout}, {3'd0}};

assign grp_fu_91_p3 = 16'd31;

assign trunc_ln997_fu_61_p1 = rows_dout[10:0];

endmodule //median_blur_accel_addrbound
