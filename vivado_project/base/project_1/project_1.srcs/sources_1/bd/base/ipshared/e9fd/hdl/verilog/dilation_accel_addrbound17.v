...
module dilation_accel_addrbound17 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [10:0] grp_fu_109_p0;
wire  signed [10:0] grp_fu_109_p1;
reg    grp_fu_109_ce;
reg   [3:0] ap_NS_fsm;
wire    ap_ce_reg;
...
assign grp_fu_109_p0 = rows_dout[10:0];

assign grp_fu_109_p1 = cols_dout[10:0];

assign rows_out_din = rows_dout;

assign shl_ln_fu_85_p3 = {{grp_fu_109_p2}, {3'd0}};

endmodule //dilation_accel_addrbound17
