...
wire   [7:0] AxiStream2MatStream_U0_imgInput1_434_din;
wire    AxiStream2MatStream_U0_imgInput1_434_write;
...
arithm_accel_Axi2Mat_entry3 Axi2Mat_entry3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
arithm_accel_Axi2Mat_entry8 Axi2Mat_entry8_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
arithm_accel_last_blk_pxl_width3 last_blk_pxl_width3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
arithm_accel_addrbound4 addrbound4_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
arithm_accel_Axi2Mat_Block_split15_proc Axi2Mat_Block_split15_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
arithm_accel_Axi2AxiStream Axi2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
arithm_accel_AxiStream2MatStream AxiStream2MatStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .imgInput1_434_din(AxiStream2MatStream_U0_imgInput1_434_din),
    .imgInput1_434_full_n(imgInput1_434_full_n),
    .imgInput1_434_write(AxiStream2MatStream_U0_imgInput1_434_write),
...
arithm_accel_fifo_w64_d2_S din_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w32_d2_S rows_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w32_d2_S cols_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w64_d4_S din_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w32_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w32_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w4_d6_S last_blk_width_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w11_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w32_d4_S rows_c13_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w32_d4_S cols_c14_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w11_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_fifo_w8_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_start_for_Axi2Mat_entry8_U0 start_for_Axi2Mat_entry8_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_start_for_addrbound4_U0 start_for_addrbound4_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
arithm_accel_start_for_AxiStream2MatStream_U0 start_for_AxiStream2MatStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (last_blk_pxl_width3_U0_ap_idle & (axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound4_U0_ap_idle & AxiStream2MatStream_U0_ap_idle & Axi2Mat_entry8_U0_ap_idle & Axi2Mat_entry3_U0_ap_idle & Axi2Mat_Block_split15_proc_U0_ap_idle & Axi2AxiStream_U0_ap_idle);
...
assign imgInput1_434_din = AxiStream2MatStream_U0_imgInput1_434_din;

assign imgInput1_434_write = AxiStream2MatStream_U0_imgInput1_434_write;
...
endmodule //arithm_accel_Axi2Mat
