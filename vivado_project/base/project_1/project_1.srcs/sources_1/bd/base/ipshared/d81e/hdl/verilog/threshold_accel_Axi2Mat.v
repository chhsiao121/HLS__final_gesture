...
module threshold_accel_Axi2Mat (
        m_axi_gmem1_AWVALID,
        m_axi_gmem1_AWREADY,
        m_axi_gmem1_AWADDR,
        m_axi_gmem1_AWID,
...
wire   [8:0] addrbound4_U0_return_r;
...
threshold_accel_Axi2Mat_entry3 Axi2Mat_entry3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_Axi2Mat_entry7 Axi2Mat_entry7_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_last_blk_pxl_width3 last_blk_pxl_width3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_addrbound4 addrbound4_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_Axi2Mat_Block_split37_proc Axi2Mat_Block_split37_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_Axi2AxiStream Axi2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_AxiStream2MatStream AxiStream2MatStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_fifo_w64_d2_S din_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S rows_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S cols_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w64_d4_S din_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w4_d6_S last_blk_width_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w9_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d4_S rows_c15_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d4_S cols_c16_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w9_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_start_for_Axi2Mat_entry7_U0 start_for_Axi2Mat_entry7_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_start_for_addrbound4_U0 start_for_addrbound4_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_start_for_AxiStream2MatStream_U0 start_for_AxiStream2MatStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (last_blk_pxl_width3_U0_ap_idle & (axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound4_U0_ap_idle & AxiStream2MatStream_U0_ap_idle & Axi2Mat_entry7_U0_ap_idle & Axi2Mat_entry3_U0_ap_idle & Axi2Mat_Block_split37_proc_U0_ap_idle & Axi2AxiStream_U0_ap_idle);
...
endmodule //threshold_accel_Axi2Mat
