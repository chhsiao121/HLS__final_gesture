...
wire    Axi2Mat_entry24_U0_ap_start;
wire    Axi2Mat_entry24_U0_ap_done;
wire    Axi2Mat_entry24_U0_ap_continue;
wire    Axi2Mat_entry24_U0_ap_idle;
wire    Axi2Mat_entry24_U0_ap_ready;
wire    Axi2Mat_entry24_U0_start_out;
wire    Axi2Mat_entry24_U0_start_write;
wire    Axi2Mat_entry24_U0_din_read;
wire    Axi2Mat_entry24_U0_rows_read;
wire    Axi2Mat_entry24_U0_cols_read;
wire   [63:0] Axi2Mat_entry24_U0_din_out_din;
wire    Axi2Mat_entry24_U0_din_out_write;
wire   [31:0] Axi2Mat_entry24_U0_rows_out_din;
wire    Axi2Mat_entry24_U0_rows_out_write;
wire   [31:0] Axi2Mat_entry24_U0_cols_out_din;
wire    Axi2Mat_entry24_U0_cols_out_write;
wire    last_blk_pxl_width16_U0_ap_start;
wire    last_blk_pxl_width16_U0_ap_done;
wire    last_blk_pxl_width16_U0_ap_continue;
wire    last_blk_pxl_width16_U0_ap_idle;
wire    last_blk_pxl_width16_U0_ap_ready;
wire    last_blk_pxl_width16_U0_start_out;
wire    last_blk_pxl_width16_U0_start_write;
wire   [3:0] last_blk_pxl_width16_U0_ret_out_din;
wire    last_blk_pxl_width16_U0_ret_out_write;
wire    addrbound17_U0_ap_start;
wire    addrbound17_U0_ap_done;
wire    addrbound17_U0_ap_continue;
wire    addrbound17_U0_ap_idle;
wire    addrbound17_U0_ap_ready;
wire   [8:0] addrbound17_U0_return_r;
wire    addrbound17_U0_return_r_ap_vld;
wire    addrbound17_U0_rows_read;
wire    addrbound17_U0_cols_read;
wire   [31:0] addrbound17_U0_rows_out_din;
wire    addrbound17_U0_rows_out_write;
wire   [31:0] addrbound17_U0_cols_out_din;
wire    addrbound17_U0_cols_out_write;
...
wire   [8:0] Axi2Mat_Block_split37_proc_U0_ap_return;
...
wire   [7:0] AxiStream2MatStream_U0_in_mat_419_din;
wire    AxiStream2MatStream_U0_in_mat_419_write;
...
reg    ap_sync_reg_last_blk_pxl_width16_U0_ap_ready;
wire    ap_sync_last_blk_pxl_width16_U0_ap_ready;
reg    ap_sync_reg_Axi2AxiStream_U0_ap_ready;
wire    ap_sync_Axi2AxiStream_U0_ap_ready;
wire   [0:0] start_for_Axi2Mat_entry24_U0_din;
wire    start_for_Axi2Mat_entry24_U0_full_n;
wire   [0:0] start_for_Axi2Mat_entry24_U0_dout;
wire    start_for_Axi2Mat_entry24_U0_empty_n;
wire   [0:0] start_for_addrbound17_U0_din;
wire    start_for_addrbound17_U0_full_n;
wire   [0:0] start_for_addrbound17_U0_dout;
wire    start_for_addrbound17_U0_empty_n;
...
wire    addrbound17_U0_start_full_n;
wire    addrbound17_U0_start_write;
...
#0 ap_sync_reg_last_blk_pxl_width16_U0_ap_ready = 1'b0;
#0 ap_sync_reg_Axi2AxiStream_U0_ap_ready = 1'b0;
end

dilation_accel_Axi2Mat_entry3 Axi2Mat_entry3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(Axi2Mat_entry3_U0_ap_start),
    .start_full_n(start_for_Axi2Mat_entry24_U0_full_n),
...
dilation_accel_Axi2Mat_entry24 Axi2Mat_entry24_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(Axi2Mat_entry24_U0_ap_start),
    .start_full_n(start_for_addrbound17_U0_full_n),
    .ap_done(Axi2Mat_entry24_U0_ap_done),
    .ap_continue(Axi2Mat_entry24_U0_ap_continue),
    .ap_idle(Axi2Mat_entry24_U0_ap_idle),
    .ap_ready(Axi2Mat_entry24_U0_ap_ready),
    .start_out(Axi2Mat_entry24_U0_start_out),
    .start_write(Axi2Mat_entry24_U0_start_write),
    .din_dout(din_c1_dout),
    .din_empty_n(din_c1_empty_n),
    .din_read(Axi2Mat_entry24_U0_din_read),
    .rows_dout(rows_c2_dout),
    .rows_empty_n(rows_c2_empty_n),
    .rows_read(Axi2Mat_entry24_U0_rows_read),
    .cols_dout(cols_c3_dout),
    .cols_empty_n(cols_c3_empty_n),
    .cols_read(Axi2Mat_entry24_U0_cols_read),
    .din_out_din(Axi2Mat_entry24_U0_din_out_din),
    .din_out_full_n(din_c_full_n),
    .din_out_write(Axi2Mat_entry24_U0_din_out_write),
    .rows_out_din(Axi2Mat_entry24_U0_rows_out_din),
    .rows_out_full_n(rows_c_full_n),
    .rows_out_write(Axi2Mat_entry24_U0_rows_out_write),
    .cols_out_din(Axi2Mat_entry24_U0_cols_out_din),
    .cols_out_full_n(cols_c_full_n),
    .cols_out_write(Axi2Mat_entry24_U0_cols_out_write)
);

dilation_accel_last_blk_pxl_width16 last_blk_pxl_width16_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(last_blk_pxl_width16_U0_ap_start),
    .start_full_n(start_for_AxiStream2MatStream_U0_full_n),
    .ap_done(last_blk_pxl_width16_U0_ap_done),
    .ap_continue(last_blk_pxl_width16_U0_ap_continue),
    .ap_idle(last_blk_pxl_width16_U0_ap_idle),
    .ap_ready(last_blk_pxl_width16_U0_ap_ready),
    .start_out(last_blk_pxl_width16_U0_start_out),
    .start_write(last_blk_pxl_width16_U0_start_write),
    .ret_out_din(last_blk_pxl_width16_U0_ret_out_din),
    .ret_out_full_n(last_blk_width_c_full_n),
    .ret_out_write(last_blk_pxl_width16_U0_ret_out_write)
);

dilation_accel_addrbound17 addrbound17_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(addrbound17_U0_ap_start),
    .ap_done(addrbound17_U0_ap_done),
    .ap_continue(addrbound17_U0_ap_continue),
    .ap_idle(addrbound17_U0_ap_idle),
    .ap_ready(addrbound17_U0_ap_ready),
    .return_r(addrbound17_U0_return_r),
    .return_r_ap_vld(addrbound17_U0_return_r_ap_vld),
    .rows_dout(rows_c_dout),
    .rows_empty_n(rows_c_empty_n),
    .rows_read(addrbound17_U0_rows_read),
    .cols_dout(cols_c_dout),
    .cols_empty_n(cols_c_empty_n),
    .cols_read(addrbound17_U0_cols_read),
    .rows_out_din(addrbound17_U0_rows_out_din),
    .rows_out_full_n(rows_c15_full_n),
    .rows_out_write(addrbound17_U0_rows_out_write),
    .cols_out_din(addrbound17_U0_cols_out_din),
    .cols_out_full_n(cols_c16_full_n),
    .cols_out_write(addrbound17_U0_cols_out_write)
);

dilation_accel_Axi2Mat_Block_split37_proc Axi2Mat_Block_split37_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
dilation_accel_Axi2AxiStream Axi2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
dilation_accel_AxiStream2MatStream AxiStream2MatStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .in_mat_419_din(AxiStream2MatStream_U0_in_mat_419_din),
    .in_mat_419_full_n(in_mat_419_full_n),
    .in_mat_419_write(AxiStream2MatStream_U0_in_mat_419_write),
...
dilation_accel_fifo_w64_d2_S din_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_read(Axi2Mat_entry24_U0_din_read)
);

dilation_accel_fifo_w32_d2_S rows_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_read(Axi2Mat_entry24_U0_rows_read)
);

dilation_accel_fifo_w32_d2_S cols_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_read(Axi2Mat_entry24_U0_cols_read)
);

dilation_accel_fifo_w64_d4_S din_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Axi2Mat_entry24_U0_din_out_din),
    .if_full_n(din_c_full_n),
    .if_write(Axi2Mat_entry24_U0_din_out_write),
    .if_dout(din_c_dout),
    .if_empty_n(din_c_empty_n),
    .if_read(Axi2AxiStream_U0_din_read)
);

dilation_accel_fifo_w32_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Axi2Mat_entry24_U0_rows_out_din),
    .if_full_n(rows_c_full_n),
    .if_write(Axi2Mat_entry24_U0_rows_out_write),
    .if_dout(rows_c_dout),
    .if_empty_n(rows_c_empty_n),
    .if_read(addrbound17_U0_rows_read)
);

dilation_accel_fifo_w32_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Axi2Mat_entry24_U0_cols_out_din),
    .if_full_n(cols_c_full_n),
    .if_write(Axi2Mat_entry24_U0_cols_out_write),
    .if_dout(cols_c_dout),
    .if_empty_n(cols_c_empty_n),
    .if_read(addrbound17_U0_cols_read)
);

dilation_accel_fifo_w4_d6_S last_blk_width_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(last_blk_pxl_width16_U0_ret_out_din),
    .if_full_n(last_blk_width_c_full_n),
    .if_write(last_blk_pxl_width16_U0_ret_out_write),
    .if_dout(last_blk_width_c_dout),
    .if_empty_n(last_blk_width_c_empty_n),
    .if_read(AxiStream2MatStream_U0_last_blk_width_read)
);

dilation_accel_fifo_w9_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(addrbound17_U0_return_r),
    .if_full_n(p_channel_full_n),
    .if_write(addrbound17_U0_ap_done),
    .if_dout(p_channel_dout),
    .if_empty_n(p_channel_empty_n),
    .if_read(Axi2Mat_Block_split37_proc_U0_ap_ready)
);

dilation_accel_fifo_w32_d4_S rows_c15_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(addrbound17_U0_rows_out_din),
    .if_full_n(rows_c15_full_n),
    .if_write(addrbound17_U0_rows_out_write),
    .if_dout(rows_c15_dout),
    .if_empty_n(rows_c15_empty_n),
    .if_read(AxiStream2MatStream_U0_rows_read)
);

dilation_accel_fifo_w32_d4_S cols_c16_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(addrbound17_U0_cols_out_din),
    .if_full_n(cols_c16_full_n),
    .if_write(addrbound17_U0_cols_out_write),
    .if_dout(cols_c16_dout),
    .if_empty_n(cols_c16_empty_n),
    .if_read(AxiStream2MatStream_U0_cols_bound_per_npc_read)
);

dilation_accel_fifo_w9_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
dilation_accel_fifo_w32_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
dilation_accel_start_for_Axi2Mat_entry24_U0 start_for_Axi2Mat_entry24_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_Axi2Mat_entry24_U0_din),
    .if_full_n(start_for_Axi2Mat_entry24_U0_full_n),
    .if_write(Axi2Mat_entry3_U0_start_write),
    .if_dout(start_for_Axi2Mat_entry24_U0_dout),
    .if_empty_n(start_for_Axi2Mat_entry24_U0_empty_n),
    .if_read(Axi2Mat_entry24_U0_ap_ready)
);

dilation_accel_start_for_addrbound17_U0 start_for_addrbound17_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_addrbound17_U0_din),
    .if_full_n(start_for_addrbound17_U0_full_n),
    .if_write(Axi2Mat_entry24_U0_start_write),
    .if_dout(start_for_addrbound17_U0_dout),
    .if_empty_n(start_for_addrbound17_U0_empty_n),
    .if_read(addrbound17_U0_ap_ready)
);

dilation_accel_start_for_AxiStream2MatStream_U0 start_for_AxiStream2MatStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_write(last_blk_pxl_width16_U0_start_write),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_last_blk_pxl_width16_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_last_blk_pxl_width16_U0_ap_ready <= 1'b0;
        end else begin
            ap_sync_reg_last_blk_pxl_width16_U0_ap_ready <= ap_sync_last_blk_pxl_width16_U0_ap_ready;
        end
    end
end
...
assign Axi2Mat_entry24_U0_ap_continue = 1'b1;

assign Axi2Mat_entry24_U0_ap_start = start_for_Axi2Mat_entry24_U0_empty_n;
...
assign addrbound17_U0_ap_continue = p_channel_full_n;

assign addrbound17_U0_ap_start = start_for_addrbound17_U0_empty_n;

assign addrbound17_U0_start_full_n = 1'b1;

assign addrbound17_U0_start_write = 1'b0;

assign ap_channel_done_axibound_V = Axi2Mat_Block_split37_proc_U0_ap_done;

assign ap_channel_done_p_channel = addrbound17_U0_ap_done;

assign ap_done = AxiStream2MatStream_U0_ap_done;

assign ap_idle = (last_blk_pxl_width16_U0_ap_idle & (axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound17_U0_ap_idle & AxiStream2MatStream_U0_ap_idle & Axi2Mat_entry3_U0_ap_idle & Axi2Mat_entry24_U0_ap_idle & Axi2Mat_Block_split37_proc_U0_ap_idle & Axi2AxiStream_U0_ap_idle);
...
assign ap_sync_last_blk_pxl_width16_U0_ap_ready = (last_blk_pxl_width16_U0_ap_ready | ap_sync_reg_last_blk_pxl_width16_U0_ap_ready);

assign ap_sync_ready = (ap_sync_last_blk_pxl_width16_U0_ap_ready & ap_sync_Axi2Mat_entry3_U0_ap_ready & ap_sync_Axi2AxiStream_U0_ap_ready);

assign in_mat_419_din = AxiStream2MatStream_U0_in_mat_419_din;

assign in_mat_419_write = AxiStream2MatStream_U0_in_mat_419_write;

assign last_blk_pxl_width16_U0_ap_continue = 1'b1;

assign last_blk_pxl_width16_U0_ap_start = ((ap_sync_reg_last_blk_pxl_width16_U0_ap_ready ^ 1'b1) & ap_start);
...
assign start_for_Axi2Mat_entry24_U0_din = 1'b1;

assign start_for_AxiStream2MatStream_U0_din = 1'b1;

assign start_for_addrbound17_U0_din = 1'b1;

endmodule //dilation_accel_Axi2Mat
