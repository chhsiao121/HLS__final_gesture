...
-- Date        : Mon Dec  6 00:52:32 2021
-- Host        : DESKTOP-I47353D running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               e:/GT/base/project_1/project_1.srcs/sources_1/bd/base/ip/base_dvi2rgb_0_0/base_dvi2rgb_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of base_dvi2rgb_0_0_TWI_SlaveCtl is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of DONE_O_i_2 : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of DONE_O_i_3 : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of END_O_i_2 : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \FSM_gray_state[0]_i_6\ : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of \FSM_gray_state[0]_i_7\ : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of \FSM_gray_state[1]_i_3\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \FSM_gray_state[1]_i_5\ : label is "soft_lutpair98";
  attribute SOFT_HLUTNM of \FSM_gray_state[1]_i_7\ : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_2\ : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_6\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_8\ : label is "soft_lutpair97";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_9\ : label is "soft_lutpair102";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \dataByte[7]_i_5\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of rd_wrn_i_1 : label is "soft_lutpair91";
  ...
  attribute SOFT_HLUTNM of \sAddr[5]_i_1\ : label is "soft_lutpair102";
begin
...
\sAddr[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8BB8B8B8B8B8B8B8"
    )
        port map (
...
architecture STRUCTURE of base_dvi2rgb_0_0_EEPROM_8b is
  ...
  signal \sAddr[6]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \sAddr[5]_i_3\ : label is "soft_lutpair103";
  attribute SOFT_HLUTNM of \sAddr[6]_i_2\ : label is "soft_lutpair103";
begin
...
I2C_SlaveController: entity work.base_dvi2rgb_0_0_TWI_SlaveCtl
     port map (
      ...
      \sAddr_reg[4]\ => \sAddr[5]_i_3_n_0\,
      \sAddr_reg[6]\ => \sAddr[6]_i_2_n_0\
    );
\sAddr[5]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
architecture STRUCTURE of base_dvi2rgb_0_0_TMDS_Clocking is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \rDlyRstCnt[1]_i_1\ : label is "soft_lutpair105";
  attribute SOFT_HLUTNM of \rDlyRstCnt[2]_i_1\ : label is "soft_lutpair105";
  attribute SOFT_HLUTNM of \rDlyRstCnt[3]_i_1\ : label is "soft_lutpair104";
  attribute SOFT_HLUTNM of \rDlyRstCnt[4]_i_2\ : label is "soft_lutpair104";
begin
...
architecture STRUCTURE of base_dvi2rgb_0_0_TMDS_Decoder_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \pBitslipCnt[0]_i_1\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \pBitslipCnt[1]_i_1\ : label is "soft_lutpair55";
  attribute ADDER_THRESHOLD : integer;
...
\DataDecoders[0].DecoderX\: entity work.base_dvi2rgb_0_0_TMDS_Decoder
     port map (
      ...
      \pDataQ_reg[8]\ => TMDS_ClockingX_n_0,
...
\DataDecoders[1].DecoderX\: entity work.base_dvi2rgb_0_0_TMDS_Decoder_0
     port map (
      ...
      pAllVld => pAllVld,
      pAllVldBgnFlag => \ChannelBondX/pAllVldBgnFlag\,
      \pDataQ_reg[1]\ => TMDS_ClockingX_n_0,
      pRdy_0 => pRdy_0,
      pRdy_1 => pRdy_1,
      pRdy_2 => pRdy_2,
      pRst_n => pRst_n,
...
TMDS_ClockingX: entity work.base_dvi2rgb_0_0_TMDS_Clocking
     port map (
      ...
      \rMMCM_Reset_q_reg[0]_0\ => TMDS_ClockingX_n_0
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity base_dvi2rgb_0_0 is
  ...
  attribute x_core_info of base_dvi2rgb_0_0 : entity is "dvi2rgb,Vivado 2020.2";
