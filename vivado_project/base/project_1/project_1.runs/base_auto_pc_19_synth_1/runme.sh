...
HD_PWD='D:/vivado_prj/base/project_1/project_1.runs/base_auto_pc_19_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_auto_pc_19.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_auto_pc_19.tcl
