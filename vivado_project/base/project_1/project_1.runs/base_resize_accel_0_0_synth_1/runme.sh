...
HD_PWD='D:/vivado_prj/base/project_1/project_1.runs/base_resize_accel_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_resize_accel_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_resize_accel_0_0.tcl
